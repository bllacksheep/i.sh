...
void parser_create_tokens(const char *, semantic_token_t **, size_t *);
...
void parser_evaluate_iterator(const char **buf, size_t *iter) {
...
void parser_evaluate_expressions(size_t argc, semantic_token_t **tokenv) {
...
void parser_simple_parser(const char *buf) {
  size_t it = 0;
  size_t tc = 0;
  size_t argc = 0;
